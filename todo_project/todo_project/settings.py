...
FIREBASE_CLIENT_CERT = config("FIREBASE_CLIENT_CERT")
...
SECRET_KEY = 'django-insecure-*b$jhgy^r_v5(i5y$2^2(^^f7oo03ye2c-585ia2=5*cwen^$+'
...
REST_FRAMEWORK = {
      ...
      'DEFAULT_AUTHENTICATION_CLASSES': (
          ...
          'users.authentication.FirebaseOptionalAuthentication',
      ),
}
